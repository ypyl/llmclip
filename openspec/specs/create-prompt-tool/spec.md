...
LLM-callable tool that creates new system prompt files (`.md` text + `.json` metadata) in the `prompts/` directory, with duplicate detection and automatic configuration reload.
